...
|------|-------------|--------------------------|
| 메인 컨테이너 | 그리드를 감싸는 최상위 div | `wu_wz` |
| 행(Row) | 한 줄(행)을 나타내는 div | `wu_vS` |
| 셀(Cell) | 각 칸(플/뱅/무 또는 P/B/T)을 나타내는 div | `wu_wB` |
...
| 적용 시기 | 메인 컨테이너 | 행 | 셀 |
|-----------|----------------|-----|-----|
| 2026-07-XX (현재) | `wu_wz` | `wu_vS` | `wu_wB` |
| 2026-07-XX | `wn_ws` | `wn_vL` | `wn_wu` |
| 2026-07-XX | `uS_uX` | `uS_uq` | `uS_uZ` |
