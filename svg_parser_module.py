...
# 2026-07-31: wn_ws/wn_vL/wn_wu → wu_wz/wu_vS/wu_wB
BEAD_ROAD_MAIN_CONTAINER_CLASS = 'wu_wz'
BEAD_ROAD_ROW_CLASS = 'wu_vS'
BEAD_ROAD_CELL_CLASS = 'wu_wB'
...
def parse_bead_road_svg(svg_code):
    ...
    - 2026-07-XX: uS_uX → wn_ws, uS_uq → wn_vL, uS_uZ → wn_wu
    - 2026-07-XX: wn_ws → wu_wz, wn_vL → wu_vS, wn_wu → wu_wB (최신 구조)
